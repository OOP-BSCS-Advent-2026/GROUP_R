 public class FlatDiscountItem extends Item { // subclass of Item
    ...
    public FlatDiscountItem(String name, double price, int threshold, double flatAmount) {// constructor to initialize the name, price, threshold, and flatAmount.
    ...
    public double calculateTotal(int quantity) {
        ...
        if (quantity >= threshold) {
            subtotal = Math.max(0, subtotal - flatAmount); // apply the flat discount if the threshold is met.
        }
